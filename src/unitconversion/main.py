...
def generate_sentances_integers(n: int, f: str, number: list):
    """
...
def generate_sentances_fractions(n: float, f: str, number: list):
    """
    Takes in a dictionary of numbers and generates sentences using those numbers.
    numbers ={
...
if __name__ == "__main__":
    ...
    output_file = "output/sentences.tsv"
    ...
    # for line in numbers:
    #     generate_sentances_fractions(*line)
